        ...
        <div className="relative min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white overflow-hidden">
            ...
            <section className="relative z-10 flex min-h-[80vh] items-center justify-center px-4">
                <div className="container text-center">
                    ...
                    >
                        <Button className="bg-[#00f2fe] text-black hover:bg-[#00d9e6] transition-transform transform hover:scale-105 hover:shadow-[0_0_15px_#00f2fe] px-12 py-6 rounded-full font-bold text-lg mb-8">
                            Get Started
                        </Button>
                    </motion.div>
                </div>
