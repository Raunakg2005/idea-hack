                ...
                >
                  <Card className="border-primary/10 bg-background/50 backdrop-blur-xl">
                    <CardContent className="grid gap-4 p-6 sm:grid-cols-2 md:grid-cols-4">
                      <div>
                        <p className="text-sm text-primary/70">Ticket ID</p>
                        <p className="font-medium text-primary">{ticket.id}</p>
                      </div>
                      <div>
                        <p className="text-sm text-primary/70">Status</p>
                        <p className="font-medium text-primary">{ticket.status}</p>
                      </div>
                      <div>
                        <p className="text-sm text-primary/70">Priority</p>
                        <p className="font-medium text-primary">{ticket.priority}</p>
                      </div>
                      <div>
                        <p className="text-sm text-primary/70">Created</p>
                        <p className="font-medium text-primary">{ticket.created}</p>
                      </div>
                      <div className="sm:col-span-2 md:col-span-4">
                        <h3 className="mb-2 font-medium text-primary">{ticket.title}</h3>
